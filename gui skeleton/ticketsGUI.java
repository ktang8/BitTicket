...
public class ticketsGUI extends JFrame implements ActionListener {
	...
	{	
		// vars. for SQL Query create
		  final String createTable = "CREATE TABLE jpapaTicket(ticket_id INT AUTO_INCREMENT PRIMARY KEY, ticket_name VARCHAR(30), ticket_description VARCHAR(200))";
		 ...
		 try {
			...
			//add in ticket information
			 ...
			 try {
	            ...
	            ResultSet results = statement.executeQuery("SELECT * FROM jpapaTicket");
